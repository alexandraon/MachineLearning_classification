...
print(compute_cross_val_with_BCR_sklearn(x_train, y_train, 5, pipeline))
#print(compute_cross_val_one_split(x_train, y_train, pipeline))
#predict on x_test
